                        ...
                        <div class="classes__sidebar__item">
                            ...
                            <div class="classes__sidebar__instructor">
                                <div class="classes__sidebar__instructor__pic">
                                    <img src="./resources/img/classes-details/classes-instructor.png" alt="">
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="classes__details">
                        <div class="classes__details__large">
                            <img src="./resources/img/classes-details/cd-large.jpg" alt="">
                            <span>Beginer</span>
                        </div>
                        ...
                        <div class="classes__details__item">
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <img src="./resources/img/classes-details/cd-item-1.jpg" alt="">
                                </div>
                                <div class="col-lg-8 col-md-8">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <img src="./resources/img/classes-details/cd-item-2.jpg" alt="">
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <img src="./resources/img/classes-details/cd-item-3.jpg" alt="">
                                        </div>
                                    </div>
                                    <img src="./resources/img/classes-details/cd-item-4.jpg" alt="">
                                </div>
                            </div>
                        </div>
