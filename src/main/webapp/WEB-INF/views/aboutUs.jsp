...
<body>
        ...
        <div class="container">
            <div class="about__services">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="services__item">
                            <img src="./resources/img/about/af-4.png" alt="">
                            <h5>Slim Body</h5>
                            <p>Grab the opportunity to deepen your own yoga practice, relax, restore and experience india!</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-7 p-0">
                    <div class="about__pic">
                        <img src="./resources/img/about/about-page-pic.png" alt="">
                    </div>
                </div>
                        ...
                        <div class="about__bar">
                            <div class="about__bar__item">
                                ...
                                <div id="bar1" class="barfiller">
                                    <span class="tip"></span>
                                    <span class="fill" data-percentage="12"></span>
                                </div>
                            </div>
                            <div class="about__bar__item">
                                <p>Methabolism</p>
            ...
            <div class="row">
                <div class="team__slider owl-carousel">
                    <div class="col-lg-6">
                        <div class="team__item">
                            <div class="team__item__pic">
                                <img src="./resources/img/team/team-1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="team__item">
                            <div class="team__item__pic">
                                <img src="./resources/img/team/team-2.png" alt="">
                            </div>
                            <div class="team__item__text">
                                <div class="team__item__title">
    ...
    <div class="counter spad">
        <div class="container">
            <div class="counter__text set-bg" data-setbg="./resources/img/counter/counter-bg.jpg">
                <div class="counter__item">
                    <div class="counter__item__icon">
                        <img src="./resources/img/counter/counter-1.png" alt="">
                    </div>
                ...
                <div class="counter__item">
                    <div class="counter__item__icon">
                        <img src="./resources/img/counter/counter-2.png" alt="">
                    </div>
                    <div class="counter__item__text">
                        <h2>15</h2>
                ...
                <div class="counter__item">
                    <div class="counter__item__icon">
                        <img src="./resources/img/counter/counter-3.png" alt="">
                    </div>
                    <div class="counter__item__text">
                        <h2>48</h2>
                        <p>Branches</p>
                ...
                <div class="counter__item">
                    <div class="counter__item__icon">
                        <img src="./resources/img/counter/counter-4.png" alt="">
                    </div>
                    <div class="counter__item__text">
                        <h2>234</h2>
                        <p>Expert Staffs</p>
