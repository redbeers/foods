...
<body>
	...
	<div>
		<h3 style="padding-left: 15px;color: #263246;font-family:DM Sans,sans-serif;font-weight: 400;">🌮 회원들과 공유할 맛있는 레시피를 작성해주세요</h3>
	</div>
	<br/><br/>
		<main role="main" class="container">
			<form name="form" method="get" action="/recipeList">
				<div class="pt-1"></div>
