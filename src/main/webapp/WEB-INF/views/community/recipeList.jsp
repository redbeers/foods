            ...
            <div class="row">
                <div class="team__slider owl-carousel">
                    <div class="col-lg-6">
                        ...
                        <div class="classes__item__pic set-bg" data-setbg="./resources/img/diet.jpg">
                        ...
                        <div class="classes__item__text" style="padding-top: 10px;padding-bottom: 10px; padding-left: 0;padding-right: 0;">
                            ...
                            <br/>
                            <h4 style="margin-bottom: 30px;font-weight: bold;"><a href="#">가볍고 든든한 다이어트 한끼 식사</a></h4>
                            <div>
                            	<div style="display: inline-block;vertical-align: middle;">
                            ...
                            <a href="recipeDetail" class="class-btn" style="width:100%; text-align: center;">상세보기</a>
                        </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <section class="classes spad">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="#">
                            ...
                            <div class="class__filter__btn_re">
            ...
            <div class="classes__item__text" style="text-align: right;padding-top: 0;">
                  <span class="blinking">당신의 특별한 레시피를 공유해보세요 → </span>&nbsp;
                  <a href="recipeAdd" class="class-btn_w">글쓰기</a>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="classes__item classes__item__page">
                        ...
                        <div class="classes__item__text" style="padding-left: 5px;padding-right: 5px;">
                            ...
                            <h4 style="margin-bottom: 30px;"><a href="recipeDetail">맛있는 다이어트 피자</a></h4>
                            <div>
                            	<div style="display: inline-block;vertical-align: middle;">
                            		<img src="./resources/img/common/writer.PNG" style="width:24px;height: 26px;opacity: 0.5;" />
                            	</div>&nbsp;
